...
export const STATIC_PUBLIC_PULSE_RECOMMENDATION_EXAMPLES: PublicPulseRecommendationExample[] = [
  {
    ...
    market_slug: "us-x-iran-ceasefire-by-march-31",
  ...
  },
  {
    ...
    market_slug: "us-forces-enter-iran-by-march-31-222-191-243-517-878-439-519",
    ...
    executed_trades: [
      ...
      {
        market_slug: "will-england-win-the-2026-fifa-world-cup-937",
