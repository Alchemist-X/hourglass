        ...
        <table className="data-table">
          ...
          <tbody>
            {data.map((position) => (
              <tr key={position.id}>
                <td data-label="市场">
                  <strong className="table-title">{position.market_slug}</strong>
                  <div className="table-subline table-code">{position.event_slug}</div>
                </td>
                <td data-label="结果">{position.outcome_label}</td>
