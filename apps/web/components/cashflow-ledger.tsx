  ...
  return (
    <section className="panel">
      ...
      <p className="panel-note">
        这本流水账来自 Polymarket 的公共 activity。它比较可靠地展示成交和 redeem，但不会完整展示 bridge 的出入金。
      </p>
            ...
            {data.map((event) => {
                ...
                return (
                  <tr key={event.id}>
                    ...
                    <td data-label="市场">
                      <strong className="table-title">{event.market_slug}</strong>
                      <div className="table-subline">{event.outcome_label}</div>
                    </td>
