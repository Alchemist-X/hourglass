    ...
    <div className="shell">
      ...
      <header className="hero">
        <div className="hero-main">
          <p className="eyebrow">{spectatorMode ? "Polymarket 围观台" : "Autonomous Polymarket Agent"}</p>
          <h1>{spectatorMode ? "像看真实账户一样看一个实盘钱包，而不是看一堆生硬调试字段。" : "公开查看一个实时交易钱包的账户状态。"}</h1>
          <p className="hero-copy">
            {spectatorMode
              ? "这个页面优先给人看，不是给系统日志看。它从 Polymarket 公共接口拉取数据，把一个钱包整理成可读的账户视图：持仓、成交、现金流和推导后的 P&L。"
        ...
        <div className="hero-rail">
          ...
          <dl className="hero-fact-list">
            ...
            <div>
              <dt>数据来源</dt>
              <dd>{spectatorMode ? "Polymarket 公共数据" : "项目公共接口"}</dd>
            </div>
            <div>
              <dt>重点内容</dt>
